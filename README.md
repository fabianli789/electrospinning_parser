# electrospinning_parser

NOMAD parser for Ka Chun Chans electrospinning simulations
...
```sh
git clone https://github.com/fabianli789/electrospinning_parser.git
cd electrospinning_parser
...
```sh
pip install dist/electrospinning_parser-0.1.0
```
